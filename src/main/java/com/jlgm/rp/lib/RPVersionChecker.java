...
public class RPVersionChecker implements Runnable{
	...
	public void run(){
		InputStream in = null;
		try{
			in = new URL("https://raw.githubusercontent.com/JoseluGames/Realistic Pathways/mc-1.10.2/versionCheck.txt").openStream();
		...
		isLatestVersion = RPConstants.VERSION.equals(latestVersion);
	}
